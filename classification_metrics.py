...
The dataset is _modified version_ of the dataset 'ozone level' on provided by UCI Machine Learning repository.
...
A _TRUE POSITIVE (TP)_ is an outcome where the model correctly predicts the positive class.
A _TRUE NEGATIVE (TN)_ is an outcome where the model correctly predicts the negative class.
A _FALSE POSITIVE (FP)_ is an outcome where the model incorrectly predicts the positive class.
a _FALSE NEGATIVE (FN)_ is an outcome where the model incorrectly predicts the negative class.
"""
